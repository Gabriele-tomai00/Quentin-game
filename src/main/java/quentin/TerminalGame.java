...
public class TerminalGame {
  ...
  private void showHelper() {
    ...
    System.out.println(
        "  startlocalgame or slg   Starts a local game (you can play with yourself in this machine)");
  ...
  private void printGamePrompt() {
    try {
      if (game.isInProgress()) {
        if (game.getCurrentPlayer().color() == BoardPoint.BLACK) System.out.print("BlackPlayer > ");
