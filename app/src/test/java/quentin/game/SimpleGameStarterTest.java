...
class SimpleGameStarterTest {
  ...
  void testBlackWin() {
    ...
    SimpleGameStarter starter = new SimpleGameStarter();
    starter.start();
    assertAll(() -> assertEquals(BoardPoint.BLACK, starter.getGame()
                                                          .getBoard()
                                                          .getPoint(new Cell(0, 0))),
              () -> assertEquals(BoardPoint.BLACK, starter.getGame()
                                                          .getBoard()
                                                          .getPoint(new Cell(12, 0))),
