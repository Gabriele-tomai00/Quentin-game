...
public class LocalGameParser {
    ...
    //    System.out.println("  startlocalgame or slg   Starts a local game (you can play with
    // yourself in this"
    //        + " machine)");
    //    System.out.println("  exit                    Quits the game and exits the program");
    //    System.out.println("  help                    Shows this help");
    //    System.out.println("  <coordinates>           Makes a move. Examples: A1 b2 C5 (wrong
    // examples: 5A," + " 24)");
    ...
    //      } else {
    //        game.getOldMatch();
    //        System.out.println("Game loaded! Your last move was at: " +
    // game.getTimestampOfLastMove() + " number of moves: "
    //            + game.getMoveCounter());
    //      }
    //    }
    //    System.out.println(game.getBoard());
