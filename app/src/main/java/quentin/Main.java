...
public class Main {
  ...
  private static void showHelper() {
    ...
    System.out.println("  startlocalgame or slg   Start a match in local mode (only one computer needed");
    System.out.println("  onlinegame or og        Start a match in LAN mode (two computer needed)");
